...
/**
 * Configure node view redirect settings.
 */
...
/><strong>Permissions allowed to view the node:</strong> create nodeType content, delete any nodeType content, delete own nodeType content, delete nodeType revisions, edit any nodeType content, revert any nodeType revisions, view nodeType revisions, revert any nodeType revisions</p>'),
    ];
    /*
     * @FormElement("table")
     */
